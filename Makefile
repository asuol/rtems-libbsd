...
LIB_C_FILES += freebsd/sys/dev/e1000/e1000_i210.c
...
TEST_SDHCI01 = testsuite/sdhci01/sdhci01.exe
TEST_SDHCI01_O_FILES =
TEST_SDHCI01_D_FILES =
TEST_SDHCI01_O_FILES += testsuite/sdhci01/test_main.o
TEST_SDHCI01_D_FILES += testsuite/sdhci01/test_main.d
$(TEST_SDHCI01): $(TEST_SDHCI01_O_FILES) $(LIB)
	$(LINK.c) -Wl,-Map,testsuite/sdhci01/sdhci01.map $^ -lm -lz -o $@
TESTS += $(TEST_SDHCI01)
O_FILES += $(TEST_SDHCI01_O_FILES)
D_FILES += $(TEST_SDHCI01_D_FILES)
RUN_TESTS += $(TEST_SDHCI01)
